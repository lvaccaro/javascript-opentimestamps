...
test('serialization', assert => {
  ...
  stamp.attestations.push(new Notary.PendingAttestation(Utils.toBytes('foobar', 'UTF-8')));
  ...
  stamp.attestations.push(new Notary.PendingAttestation(Utils.toBytes('barfoo', 'UTF-8')));
  ...
  stamp.attestations.push(new Notary.PendingAttestation(Utils.toBytes('foobaz', 'UTF-8')));
  buffer = Buffer.concat([
    Buffer.from([0xff, 0x00]),
    Buffer.from(Utils.hexToBytes('83dfe30d2ef90c8e0706')),
    Buffer.from(Utils.toBytes('barfoo', 'UTF-8')),
  ...
  const pendingAttestation = new Notary.PendingAttestation(Utils.toBytes('deeper', 'UTF-8'));
